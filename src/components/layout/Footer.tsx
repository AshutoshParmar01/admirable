        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <a href="#" className="flex items-center">
              <span className="text-xl font-bold text-gradient">SiteForge</span>
            </a>
            <p className="mt-4 text-slate-600 text-sm">
              Creating beautiful websites tailored to your specific requirements, with no coding required.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#" className="text-slate-600 hover:text-primary transition-colors">Templates</a>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#" className="text-slate-600 hover:text-primary transition-colors">Careers</a>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#" className="text-slate-600 hover:text-primary transition-colors">Cookie Policy</a>
              </li>
            </ul>
          </div>
        </div>
